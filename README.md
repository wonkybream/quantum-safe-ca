...
Two folders neet to be created under `ca/` folder, one for _server certificate chain_ and one for _iot certificate chain_. You can use [_full_ca.sh_](./scripts/full_ca.sh) script for that.
